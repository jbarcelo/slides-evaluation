  ...
  \frametitle{First Results}
      \begin{block}{}
        \begin{itemize}
          ...
          \item Assessment of the performance improved by collision-free operation when ARF is taken into account.
...
\begin{frame}{Summary}
  ...
  \begin{block}{}
        \begin{center}
          \begin{itemize}
            \item The research goal to contribute to the development of effective MAC protocols for wireless mesh networks.
            \item Teaching in the area of network protocols.
          \end{itemize}
        \end{center}
  \end{block}
